      ...
      <div className="section-wrap">
        ...
        <div className="hero-right">
          ...
          <p>
            ...
            valuable insight into optimizing logic and data. I’m excited to
            build tools that help people and businesses thrive.
          </p>
          <div className="hero-buttons">
            <a href="/docs/jenkwilliamsresume.pdf" className="outline-button" target="_blank" rel="noreferrer">
  Resume
</a>
