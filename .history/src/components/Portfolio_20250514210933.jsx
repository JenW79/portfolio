...
export default function Portfolio() {
  ...
  const projects = [
    ...
    description: "A collaborative group retro-inspired e-commerce app project built with Flask and React (Vite), bringing back the best of the '80s, '90s, and 2000s through curated nostalgic items.",
